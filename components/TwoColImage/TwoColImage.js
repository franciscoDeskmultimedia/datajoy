...
const TwoColImage = (props) => {
  return (
    ...
    >   
        ...
        :
        <div style={{backgroundColor:props.backgroundColor}} className="flex items-center justify-center w-full p-16 px-20 py-20 containImage bg-lightblue-500 lg:w-1/2">
            <Image
            layout="intrinsic"
            src={props.imageSrc}
      ...
      <div className="w-full px-20 py-20 lg:w-1/2">
        ...
        <div className="mt-12">
          <PrimaryButton  buttonColor={props.ctaBgColor} linkName={props.ctaName} url={props.ctaUrl} />
        </div>
      </div>
    </section>
  );
